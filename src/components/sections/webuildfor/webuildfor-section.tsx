...
export default function WeBuildForSection() {
  return (
    <FadeIn direction="up" distance={30} duration={0.7} className="px-8 w-full flex items-center justify-center my-[30px]">
      <div className="container">
        <div className="flex flex-col xl:flex-row gap-[54px] xl:gap-[112px] justify-between">
          ...
          <div className="w-full max-w-[100%] 2xl:max-w-[560px] flex flex-col gap-[40px]">
                ...
                <FadeIn key={index} direction="up" delay={0.5 + index * 0.15} duration={0.6}>
                  <HoverCard hoverScale={1.01} className="rounded-lg transition-colors duration-300">
                    <div className="flex flex-col gap-[16px] lg:gap-[10px] 2xl:gap-[16px]">
                      ...
                      <p className="text-white/50 lg:max-w-[430px] 2xl:max-w-[100%] text-[16px] lg:text-[12px] 2xl:text-[16px] font-normal hover:text-white/70 transition-colors duration-300">{items.description}</p>
                    </div>
                  </HoverCard>
                </FadeIn>
              ))}
