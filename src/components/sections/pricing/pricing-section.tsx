...
export default function PricingSection() {
  return (
    <FadeIn direction="up" distance={40} duration={0.8} className="px-8 py-[64px] w-full flex items-center justify-center">
                    ...
                    <div className="flex flex-col gap-[13px]">
                      {plan.buttons.map((button, buttonIndex) => (
                        <HoverCard key={buttonIndex} hoverScale={1.01} hoverElevation>
                          <Button variant="customWithGradient" className={`!w-full 2xl:!w-full text-white text-base font-medium ${buttonIndex === 0 ? '' : 'bg-white text-black'}`}>
