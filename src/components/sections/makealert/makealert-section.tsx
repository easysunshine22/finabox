    ...
    <FadeIn direction="up" distance={30} duration={0.7} className="px-8 py-[85px] w-full flex items-center justify-center">
      <div className="w-[842.66px] flex flex-col">
        <div className="flex items justify-center">
          <FadeIn direction="right" delay={0.3} duration={0.8} className="flex-1 flex items-center justify-center relative min-h-[376px] sm:min-h-[450px] md:min-h-[600px] xl:min-h-[562px]">
