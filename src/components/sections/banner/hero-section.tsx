      ...
      <div className="container relative flex flex-col items-center">
        ...
        <div className="relative -top-[35px] md:-top-[30px] lg:-top-[75px] 2xl:-top-[145px] flex flex-col items-center justify-center">
          <FadeIn direction="up" delay={0.4} distance={60} duration={0.8} className="max-w-[328px] sm:max-w-[1049px]">
            <h1 className="font-bold gradientTextColor text-[55px] x360:text-[60px] xs:text-[80px] sm:text-[120px] lg:text-[185px] 2xl:text-[256px] leading-[80px] sm:leading-[130px] lg:leading-[210px] 2xl:leading-[350px]">
              Finabox
            </h1>
          </FadeIn>
          ...
          <StaggeredFadeIn
            ...
            distance={20}
            duration={0.6}
            className="w-full sm:w-[376px] 2xl:w-[512px] flex flex-col items-center justify-center gap-3 lg:gap-2 2xl:gap-3 text-center mt-5 sm:mt-0"
          >
