      ...
      <div className="w-[1408px] relative flex flex-col items-center">
        ...
        <div className="relative -top-[45px] sm:-top-[80px] md:-top-[90px] lg:-top-[110px] xl:-top-[128px] flex flex-col items-center justify-center">
          ...
          <FadeIn direction="up" delay={0.4} distance={60} duration={0.8}>
            <h1 className="font-bold gradientTextColor text-[80px] sm:text-[128px] md:text-[128px] lg:text-[200px] xl:text-[256px] leading-[352px] text-center">
              Finabox
            </h1>
          </FadeIn>

          <StaggeredFadeIn direction="up" initialDelay={0.6} staggerDelay={0.15} distance={20} duration={0.6} className="w-[306px] sm:w-[512px] flex flex-col gap-3 text-center">
